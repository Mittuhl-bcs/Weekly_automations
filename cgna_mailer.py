...
def send_email(attachment_filename, attachment_display_name):
    ...
    try:
        ...
        subject = 'CGNA reports'
        body = """Hi Team,
A report of CGNA is generated and shared through this automated mail. Please find the ZIP file attached.
...
def sender(folder_path):
    ...
    attachment_display_name = f"CGNA_reports_{day}_{month}_{year}.zip"
